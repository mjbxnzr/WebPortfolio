...
import { Check, ArrowRight, MessageCircle, Globe, Zap, Smartphone, ShieldCheck } from "lucide-react";
    ...
    <nav className="fixed top-0 left-0 right-0 z-50 apple-blur border-b border-apple-gray-100">
      <div className="max-w-7xl mx-auto px-6 h-14 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-8 text-sm font-medium text-apple-dark/80">
          ...
          <a href="https://wa.me/60123456789" className="bg-apple-blue text-white px-4 py-1.5 rounded-full hover:bg-apple-blue/90 transition-colors">
            WhatsApp Me
          </a>
        </div>
        <div className="md:hidden">
           <a href="https://wa.me/60123456789" className="text-apple-blue">
      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          <a 
            ...
            className="inline-flex items-center space-x-2 bg-apple-dark text-white px-8 py-4 rounded-full text-lg font-medium hover:bg-apple-dark/90 transition-all transform hover:scale-105"
          >
...
const ProblemSolution = () => {
  const features = [
    ...
    {
      icon: <MessageCircle className="text-apple-blue" />,
      title: "Easy Contact",
      desc: "Direct WhatsApp integration so leads can reach you with one click."
    }
  ];
  ...
  return (
    <section className="section-padding bg-apple-dark text-white">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <a 
          href="https://wa.me/60123456789" 
          className="inline-flex items-center space-x-2 bg-white text-apple-dark px-10 py-5 rounded-full text-xl font-bold hover:bg-apple-gray-50 transition-all transform hover:scale-105"
        >
          <MessageCircle size={24} />
    ...
    <footer className="py-12 px-6 border-t border-apple-gray-100">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
        ...
        <div className="flex space-x-6 text-sm font-medium text-apple-dark/60">
          ...
          <a href="https://wa.me/60123456789" className="hover:text-apple-blue">Contact</a>
        </div>
      </div>
    </footer>
  );
